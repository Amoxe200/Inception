...
wp --path=/var/www/html/wp core install --url=https://$SERVER_NAME --title=Inception --admin_user=wpadmin --admin_password=secret --admin_email=admin@email.com --skip-email  --allow-root
